...
predic_dir=readpara["filepaths"]["predic_dir"]
...
X_train, y_train = load_xy_from_file(pre_dir, input_size, output_size)
...
from DFT_function.fun import predict_modle,insert_column_and_save,get_datetime_string

# 评估加载的模型
predictions=predict_modle(model,train_loader)

save_x=X_train.values




predir_result_dir=predic_dir+get_datetime_string()+"_result.csv"


pre_result=insert_column_and_save(X_train,predictions,"Predict_Result",predir_result_dir,index_out=False)
